...
* magic_get: https://github.com/boostorg/pfr/releases/tag/2.0.0 with increased via `python misc/generate_cpp17.py 200 > include/boost/pfr/detail/core17_generated.hpp` fileds count limit
