...
template <typename T>
concept ProtoRepeated = meta::kIsCvInstantiationOf<::google::protobuf::RepeatedField, T> ||
...
template <typename T>
concept ProtoStruct = std::is_class_v<T> && !
std::is_same_v<CompatibleMessageType<T>, void>;
