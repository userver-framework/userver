...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        UInt64FromJsonFailureTestParam{R"({"field1":[],"field2":1})", ReadErrorCode::kInvalidType, "field1"},
        UInt64FromJsonFailureTestParam{R"({"field1":1,"field2":{}})", ReadErrorCode::kInvalidType, "field2"},
        UInt64FromJsonFailureTestParam{R"({"field1":1,"field2":true})", ReadErrorCode::kInvalidType, "field2"},
        UInt64FromJsonFailureTestParam{
            R"({"field1":18446744073709551616,"field2":1})",
            ReadErrorCode::kInvalidValue,
            "field1"
        },
        UInt64FromJsonFailureTestParam{R"({"field1":1,"field2":-1})", ReadErrorCode::kInvalidValue, "field2"},
        UInt64FromJsonFailureTestParam{
            R"({"field1":"18446744073709551616","field2":1})",
            ReadErrorCode::kInvalidValue,
            "field1"
        ...
        UInt64FromJsonFailureTestParam{R"({"field1":1,"field2":"-1"})", ReadErrorCode::kInvalidValue, "field2"},
        UInt64FromJsonFailureTestParam{R"({"field1":1e50,"field2":1})", ReadErrorCode::kInvalidValue, "field1"},
        UInt64FromJsonFailureTestParam{R"({"field1":1,"field2":-1e50})", ReadErrorCode::kInvalidValue, "field2"},
        UInt64FromJsonFailureTestParam{R"({"field1":" 123","field2":1})", ReadErrorCode::kInvalidValue, "field1"},
        UInt64FromJsonFailureTestParam{R"({"field1":1,"field2":"123 "})", ReadErrorCode::kInvalidValue, "field2"},
        UInt64FromJsonFailureTestParam{R"({"field1":"1a3","field2":1})", ReadErrorCode::kInvalidValue, "field1"},
        UInt64FromJsonFailureTestParam{R"({"field1":"1.1","field2":1})", ReadErrorCode::kInvalidValue, "field1"},
        UInt64FromJsonFailureTestParam{R"({"field1":1,"field2":"-1e50"})", ReadErrorCode::kInvalidValue, "field2"},
        UInt64FromJsonFailureTestParam{R"({"field1":"1e50","field2":1})", ReadErrorCode::kInvalidValue, "field1"}
    )
);
