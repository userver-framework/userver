...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        Int32FromJsonFailureTestParam{R"({"field1":[],"field2":1,"field3":1})", ReadErrorCode::kInvalidType, "field1"},
        Int32FromJsonFailureTestParam{R"({"field1":1,"field2":{},"field3":1})", ReadErrorCode::kInvalidType, "field2"},
