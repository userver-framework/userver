...
void CallNestedMessage(google::protobuf::Message& message,
...
void GetNestedMessageDescriptorsImpl(
  ...
  for (const google::protobuf::FieldDescriptor* field :
       GetFieldDescriptors(descriptor)) {
...
std::unordered_set<const google::protobuf::Descriptor*>
GetNestedMessageDescriptorsSet(const google::protobuf::Descriptor& descriptor) {
  std::unordered_set<const google::protobuf::Descriptor*> result;
...
const google::protobuf::Descriptor* FindGeneratedMessage(
...
void BaseVisitor<Callback>::Compile(
    const google::protobuf::Descriptor* descriptor) {
  UINVARIANT(descriptor, "descriptor is nullptr");
...
void BaseVisitor<Callback>::Compile(const DescriptorList& descriptors) {
  ...
  for (const google::protobuf::Descriptor* descriptor :
       GetFullSubtrees(descriptors)) {
    UINVARIANT(descriptor, "descriptor is nullptr");
...
template <typename Callback>
void BaseVisitor<Callback>::Visit(google::protobuf::Message& message,
                                  Callback callback) {
...
template <typename Callback>
void BaseVisitor<Callback>::VisitRecursive(google::protobuf::Message& message,
                                           Callback callback) {
  // Compile if not yet compiled
  Compile(message.GetDescriptor());
...
template <typename Callback>
typename BaseVisitor<Callback>::DescriptorSet
BaseVisitor<Callback>::GetFullSubtrees(
    const DescriptorList& descriptors) const {
...
template <typename Callback>
void BaseVisitor<Callback>::PropagateSelected(
    const google::protobuf::Descriptor* descriptor) {
  UINVARIANT(descriptor, "descriptor is nullptr");
  if (!IsSelected(*descriptor) &&
      fields_with_selected_children_.find(descriptor) ==
          fields_with_selected_children_.end()) {
...
void BaseVisitor<Callback>::VisitRecursiveImpl(
    google::protobuf::Message& message, Callback callback,
    int recursion_limit) {
  UINVARIANT(recursion_limit > 0,
             "Recursion limit reached while traversing protobuf Message.");
...
void FieldsVisitor::DoVisit(google::protobuf::Message& message,
                            FieldVisitCallback callback) {
...
void MessagesVisitor::CompileOne(
    const google::protobuf::Descriptor& descriptor) {
...
void MessagesVisitor::DoVisit(google::protobuf::Message& message,
                              MessageVisitCallback callback) {
