...
struct PreCore final {
    ...
    static inline const auto dependency = MiddlewareDependencyBuilder();
};
...
struct Logging final {
    ...
    static inline const auto dependency = MiddlewareDependencyBuilder().After<PreCore>();
};

/// @brief The Group for authentication middlewares. Is located after `Logging`.
struct Auth final {
    static constexpr std::string_view kName = "auth";
    static inline const auto dependency = MiddlewareDependencyBuilder().After<Logging>();
};
...
struct Core final {
    ...
    static inline const auto dependency = MiddlewareDependencyBuilder().After<Auth>();
};

/// @brief The group is located after `Core`.
struct PostCore final {
    static constexpr std::string_view kName = "post-core";
    static inline const auto dependency = MiddlewareDependencyBuilder().After<Core>();
};
...
struct User final {
    ...
    static inline const auto dependency = MiddlewareDependencyBuilder().After<PostCore>();
};
