...
public:
    explicit MethodStatistics(StatisticsDomain domain, utils::statistics::StripedRateCounter& global_started);
    ...
    friend void DumpMetric(utils::statistics::Writer& writer, const MethodStatistics& stats);
