...
struct SecurityConfiguration final {
    ...
    struct SaslPlaintext final {
        std::string security_mechanism;
    };
    struct SaslSsl final {
        std::string security_mechanism;
...
public:
    ...
    Configuration(const std::string& name, const ConsumerConfiguration& configuration, const Secret& secrets);

    Configuration(const std::string& name, const ProducerConfiguration& configuration, const Secret& secrets);
...
private:
    ...
    void SetSecurity(const SecurityConfiguration& security, const Secret& secrets);
