...
struct NumericColumn final {
    ...
    static clickhouse::impl::clickhouse_cpp::ColumnRef Serialize(const container_type& from) {
        return std::make_shared<clickhouse::impl::clickhouse_cpp::ColumnVector<value_type>>(from);
    }
};
