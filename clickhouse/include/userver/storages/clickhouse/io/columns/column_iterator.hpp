...
template <typename ColumnType>
typename ColumnIterator<ColumnType>::reference ColumnIterator<ColumnType>::operator*() const {
    return data_.UpdateValue();
}

template <typename ColumnType>
typename ColumnIterator<ColumnType>::pointer ColumnIterator<ColumnType>::operator->() const {
    return &data_.UpdateValue();
}
...
template <typename ColumnType>
bool ColumnIterator<ColumnType>::operator!=(const ColumnIterator<ColumnType>& other) const {
    return !((*this) == other);
}
...
template <typename ColumnType>
typename ColumnIterator<ColumnType>::DataHolder ColumnIterator<ColumnType>::DataHolder::operator++(int) {
    DataHolder old{};
    old.column_ = column_;
    old.ind_ = ind_++;
...
template <typename ColumnType>
typename ColumnIterator<ColumnType>::DataHolder& ColumnIterator<ColumnType>::DataHolder::operator++() {
    ++ind_;
    current_value_.reset();
...
template <typename ColumnType>
typename ColumnIterator<ColumnType>::value_type& ColumnIterator<ColumnType>::DataHolder::UpdateValue() {
...
template <typename ColumnType>
bool ColumnIterator<ColumnType>::DataHolder::operator==(const DataHolder& other) const {
