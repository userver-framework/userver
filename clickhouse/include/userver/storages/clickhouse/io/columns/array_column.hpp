...
public:
    ...
    public:
        ...
        ArrayDataHolder(typename ColumnIterator<ArrayColumn<T>>::IteratorPosition iter_position, ColumnRef&& column);
...
template <typename T>
typename ArrayColumn<T>::ArrayDataHolder& ArrayColumn<T>::ArrayDataHolder::operator++() {
    ++ind_;
    current_value_.reset();
...
template <typename T>
typename ArrayColumn<T>::cpp_type& ArrayColumn<T>::ArrayDataHolder::UpdateValue() {
...
template <typename T>
bool ArrayColumn<T>::ArrayDataHolder::operator==(const ArrayDataHolder& other) const {
...
template <typename T>
typename ArrayColumn<T>::cpp_type ArrayColumn<T>::RetrieveElement(const ColumnRef& ref, std::size_t ind) {
