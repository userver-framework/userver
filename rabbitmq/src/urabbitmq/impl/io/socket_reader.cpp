...
bool SocketReader::Buffer::Read(engine::io::RwBase& socket, AmqpConnection* conn, AmqpConnectionHandler& parent) {
    try {
        ...
        last_bytes_read_ = is_readable ? socket.ReadSome(&tmp_buffer_[0], kTmpBufferSize, {}) : 0;
