...
void ConnectionStatistics::AccountConnectionCreated() { ++connections_created_; }
...
ConnectionStatistics::Frozen& ConnectionStatistics::Frozen::operator+=(const Frozen& other) {
