...
@pytest.mark.parametrize('path', ['/possible/to/work/from/subpath/index.html',])
...
@pytest.mark.parametrize('path', ['/possible/to/work/from/subpath/dir1/dir2', '/possible/to/work/from/subpath/dir1/dir2/'])
