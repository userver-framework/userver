...
```
cd existing_repo
git remote add origin https://git.yandex-academy.ru/torina4/realmedium.git
git branch -M master
...
- [ ] [Set up project integrations](https://git.yandex-academy.ru/torina4/realmedium/-/settings/integrations)
