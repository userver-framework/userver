...
using SomeServerMiddlewareFactory = server::middlewares::SimpleHttpMiddlewareFactory<SomeServerMiddleware>;
/// [Middlewares sample - some middleware factory implementation]
...
int main(int argc, char* argv[]) {
    const auto component_list =
        components::MinimalServerComponentList()
            ...
            .Append<samples::http_middlewares::Handler>("handler-with-custom-middlewares")
            .Append<samples::http_middlewares::Handler>("handler-with-another-middleware-configuration")
            // middlewares
            // clang-format off
