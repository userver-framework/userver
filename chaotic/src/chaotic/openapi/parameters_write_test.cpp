...
class ParameterSinkMock : public co::ParameterSinkBase {
 public:
  ...
  MOCK_METHOD(void, SetMultiQuery,
              (std::string_view, std::vector<std::string>&&), (override));
};
...
UTEST(OpenapiParameters, Cookie) {
  ...
  co::WriteParameter<co::TrivialParameter<co::In::kCookie, kTest, std::string>>(
      "value", sink);
}
...
UTEST(OpenapiParameters, Path) {
  ...
  co::WriteParameter<co::TrivialParameter<co::In::kPath, kTest, std::string>>(
      "value", sink);
}
...
UTEST(OpenapiParameters, Header) {
  ...
  co::WriteParameter<co::TrivialParameter<co::In::kHeader, kTest, std::string>>(
      "value", sink);
}
...
UTEST(OpenapiParameters, Query) {
  ...
  co::WriteParameter<co::TrivialParameter<co::In::kQuery, kTest, std::string>>(
      "value", sink);
}

UTEST(OpenapiParameters, QueryExplode) {
  ParameterSinkMock sink;
  EXPECT_CALL(sink, SetMultiQuery(std::string_view{"test"},
                                  (std::vector<std::string>{"foo", "bar"})));

  co::WriteParameter<
      co::ArrayParameter<co::In::kQueryExplode, kTest, ',', std::string>>(
...
UTEST(OpenapiParameters, QueryExplodeInteger) {
  ...
  co::WriteParameter<
      co::ArrayParameter<co::In::kQueryExplode, kTest, ',', int>>(
      std::vector<int>{1, 2}, sink);
}
...
UTEST(OpenapiParameters, QueryExplodeUser) {
  ...
  co::WriteParameter<co::ArrayParameter<co::In::kQueryExplode, kTest, ',',
                                        std::string, Decimal>>(
...
UTEST(OpenapiParameters, CookieArray) {
  ParameterSinkMock sink;
  EXPECT_CALL(sink,
              SetCookie(std::string_view{"test"}, std::string{"foo,bar"}));

  co::WriteParameter<co::ArrayParameter<co::In::kCookie, kTest, ',',
...
UTEST(OpenapiParameters, QueryArrayOfInteger) {
  ...
  co::WriteParameter<co::ArrayParameter<co::In::kQuery, kTest, ',', int>>(
      {1, 2}, sink);
}
...
UTEST(OpenapiParameters, QueryArrayOfUserTypes) {
  ...
  using Decimal = decimal64::Decimal<10>;
  co::WriteParameter<
      co::ArrayParameter<co::In::kQuery, kTest, ',', std::string, Decimal>>(
...
UTEST(OpenapiParameters, UserType) {
  ...
  using Decimal = decimal64::Decimal<10>;
  co::WriteParameter<
      co::TrivialParameter<co::In::kCookie, kTest, std::string, Decimal>>(
      Decimal{"1.1"}, sink);
}
...
UTEST(OpenapiParameters, TypeBoolean) {
  ...
  bool bool_var = true;
  co::WriteParameter<co::TrivialParameter<co::In::kCookie, kTest, bool>>(
      bool_var, sink);
}
...
UTEST(OpenapiParameters, TypeDouble) {
  ...
  co::WriteParameter<co::TrivialParameter<co::In::kCookie, kTest, double>>(
      double_var, sink);
}
...
UTEST(OpenapiParameters, TypeInt) {
  ...
  int int_var = 1;
  co::WriteParameter<co::TrivialParameter<co::In::kCookie, kTest, int>>(int_var,
                                                                        sink);
}
...
UTEST(OpenapiParameters, SinkHttpClient) {
  ...
  bool called = false;
  utest::HttpServerMock http_server(
      [&called](const utest::HttpServerMock::HttpRequest& request) {
  ...
  co::ParameterSinkHttpClient sink(request,
                                   http_server.GetBaseUrl() + "/{name}");

  co::WriteParameter<
      co::ArrayParameter<co::In::kQueryExplode, kVar1, ',', std::string>>(
      std::vector<std::string>{"foo", "bar"}, sink);
  co::WriteParameter<co::TrivialParameter<co::In::kQuery, kVar2, std::string>>(
      "foo1", sink);

  co::WriteParameter<co::TrivialParameter<co::In::kHeader, kName, std::string>>(
      "foo2", sink);
  co::WriteParameter<co::TrivialParameter<co::In::kCookie, kName, std::string>>(
      "foo3", sink);
  co::WriteParameter<co::TrivialParameter<co::In::kPath, kName, std::string>>(
      "foo4", sink);
  sink.Flush();
...
UTEST(OpenapiParameters, InvalidPathVariable) {
  ...
  EXPECT_THROW(
      (co::WriteParameter<
          co::TrivialParameter<co::In::kPath, kTest, std::string, std::string>>(
          "foo?bar", sink)),
      std::runtime_error);
