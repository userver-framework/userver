...
bool operator==(const AllOf::Foo& lhs, const AllOf::Foo& rhs) {
    return static_cast<const AllOf::Foo__P0&>(lhs) == static_cast<const AllOf::Foo__P0&>(rhs) &&
           static_cast<const AllOf::Foo__P1&>(lhs) == static_cast<const AllOf::Foo__P1&>(rhs);
}

bool operator==(const AllOf& lhs, const AllOf& rhs) { return lhs.foo == rhs.foo && true; }
...
AllOf::Foo Parse(USERVER_NAMESPACE::formats::json::Value json, USERVER_NAMESPACE::formats::parse::To<AllOf::Foo> to) {
    return Parse<USERVER_NAMESPACE::formats::json::Value>(json, to);
}

AllOf Parse(USERVER_NAMESPACE::formats::json::Value json, USERVER_NAMESPACE::formats::parse::To<AllOf> to) {
    return Parse<USERVER_NAMESPACE::formats::json::Value>(json, to);
}
...
USERVER_NAMESPACE::
    formats::
        json::
            Value
            Serialize([[maybe_unused]] const AllOf::Foo__P0& value, USERVER_NAMESPACE::formats::serialize::To<USERVER_NAMESPACE::formats::json::Value>) {
...
USERVER_NAMESPACE::
    formats::
        json::
            Value
            Serialize([[maybe_unused]] const AllOf::Foo__P1& value, USERVER_NAMESPACE::formats::serialize::To<USERVER_NAMESPACE::formats::json::Value>) {
    USERVER_NAMESPACE::formats::json::ValueBuilder vb = value.extra;
...
USERVER_NAMESPACE::formats::json::
    Value
    Serialize([[maybe_unused]] const AllOf& value, USERVER_NAMESPACE::formats::serialize::To<USERVER_NAMESPACE::formats::json::Value>) {
    USERVER_NAMESPACE::formats::json::ValueBuilder vb = USERVER_NAMESPACE::formats::common::Type::kObject;
