...
String Parse(USERVER_NAMESPACE::formats::json::Value json, USERVER_NAMESPACE::formats::parse::To<String> to) {
    return Parse<USERVER_NAMESPACE::formats::json::Value>(json, to);
}

String Parse(USERVER_NAMESPACE::formats::yaml::Value json, USERVER_NAMESPACE::formats::parse::To<String> to) {
    return Parse<USERVER_NAMESPACE::formats::yaml::Value>(json, to);
}

String Parse(USERVER_NAMESPACE::yaml_config::Value json, USERVER_NAMESPACE::formats::parse::To<String> to) {
...
USERVER_NAMESPACE::
    formats::
        json::
            Value
            Serialize([[maybe_unused]] const String& value, USERVER_NAMESPACE::formats::serialize::To<USERVER_NAMESPACE::formats::json::Value>) {
