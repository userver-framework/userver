...
bool operator==(const ns::A& lhs, const ns::A& rhs) {
    return lhs.type == rhs.type && lhs.a_prop == rhs.a_prop &&
           lhs.extra == rhs.extra &&
...
A Parse(USERVER_NAMESPACE::formats::json::Value json,
        USERVER_NAMESPACE::formats::parse::To<ns::A> to) {
...
USERVER_NAMESPACE::formats::json::Value Serialize(
    ...
    if (value.type) {
        vb["type"] =
            USERVER_NAMESPACE::chaotic::Primitive<std::string>{*value.type};
    }

    if (value.a_prop) {
        vb["a_prop"] =
            USERVER_NAMESPACE::chaotic::Primitive<int>{*value.a_prop};
    }
...
bool operator==(const ns::B& lhs, const ns::B& rhs) {
    return lhs.type == rhs.type && lhs.b_prop == rhs.b_prop &&
           lhs.extra == rhs.extra &&
...
B Parse(USERVER_NAMESPACE::formats::json::Value json,
        USERVER_NAMESPACE::formats::parse::To<ns::B> to) {
    return Parse<USERVER_NAMESPACE::formats::json::Value>(json, to);
}
...
USERVER_NAMESPACE::formats::json::Value Serialize(
    ...
    if (value.b_prop) {
        vb["b_prop"] =
            USERVER_NAMESPACE::chaotic::Primitive<int>{*value.b_prop};
    }
