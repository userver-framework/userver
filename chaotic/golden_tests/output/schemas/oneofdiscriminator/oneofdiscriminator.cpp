    ...
    USERVER_NAMESPACE::formats::parse::To<A>)
{
    return USERVER_NAMESPACE::formats::json::parser::ParseToType<
        ...
        USERVER_NAMESPACE::chaotic::sax::impl::RemoveUserTypeParser<
            USERVER_NAMESPACE::chaotic::sax::Parser<A>
        >
    >(json);
}
...
A Parse(
    ...
    USERVER_NAMESPACE::formats::parse::To<A> to)
{
    ...
    USERVER_NAMESPACE::formats::parse::To<B>)
{
    return USERVER_NAMESPACE::formats::json::parser::ParseToType<
        B,
        USERVER_NAMESPACE::chaotic::sax::impl::RemoveUserTypeParser<
            USERVER_NAMESPACE::chaotic::sax::Parser<B>
        >
    >(json);
}
...
B Parse(
    USERVER_NAMESPACE::formats::json::Value json,
    USERVER_NAMESPACE::formats::parse::To<B> to)
{
    return Parse<USERVER_NAMESPACE::formats::json::Value>(json, to);
}
    ...
    USERVER_NAMESPACE::formats::parse::To<C>)
{
    return USERVER_NAMESPACE::formats::json::parser::ParseToType<
        C,
        USERVER_NAMESPACE::chaotic::sax::impl::RemoveUserTypeParser<
            USERVER_NAMESPACE::chaotic::sax::Parser<C>
        >
    >(json);
}
...
C Parse(
    USERVER_NAMESPACE::formats::json::Value json,
    USERVER_NAMESPACE::formats::parse::To<C> to)
{
    return Parse<USERVER_NAMESPACE::formats::json::Value>(json, to);
}
    ...
    USERVER_NAMESPACE::formats::parse::To<D>)
{
    return USERVER_NAMESPACE::formats::json::parser::ParseToType<
        D,
        USERVER_NAMESPACE::chaotic::sax::impl::RemoveUserTypeParser<
            USERVER_NAMESPACE::chaotic::sax::Parser<D>
        >
    >(json);
}
...
D Parse(
    USERVER_NAMESPACE::formats::json::Value json,
    USERVER_NAMESPACE::formats::parse::To<D> to)
{
    return Parse<USERVER_NAMESPACE::formats::json::Value>(json, to);
}
...
IntegerOneOfDiscriminator FromJsonString(
    std::string_view json,
    USERVER_NAMESPACE::formats::parse::To<IntegerOneOfDiscriminator>)
{
    return USERVER_NAMESPACE::formats::json::parser::ParseToType<
        ...
        USERVER_NAMESPACE::chaotic::sax::impl::RemoveUserTypeParser<
            USERVER_NAMESPACE::chaotic::sax::Parser<IntegerOneOfDiscriminator>
        >
    >(json);
}
    ...
    USERVER_NAMESPACE::formats::serialize::To<USERVER_NAMESPACE::formats::json::Value>)
{
    ...
    if (value.foo) {
        vb["foo"] =
            USERVER_NAMESPACE::chaotic::OneOfWithDiscriminator<&::ns::IntegerOneOfDiscriminator::kFoo_Settings, USERVER_NAMESPACE::chaotic::Primitive<::ns::C>, USERVER_NAMESPACE::chaotic::Primitive<::ns::D>>{
                *value.foo
            };
    }
    ...
    [[maybe_unused]] std::string_view hide_field_name)
{
    ...
    if (value.foo && hide_field_name != "foo") {
        sw.Key("foo");
        WriteToStream(USERVER_NAMESPACE::chaotic::OneOfWithDiscriminator<&::ns::IntegerOneOfDiscriminator::kFoo_Settings, USERVER_NAMESPACE::chaotic::Primitive<::ns::C>, USERVER_NAMESPACE::chaotic::Primitive<::ns::D>>{
            *value.foo
        }, sw);
    }
}

OneOfDiscriminator FromJsonString(
    std::string_view json,
    USERVER_NAMESPACE::formats::parse::To<OneOfDiscriminator>)
{
    return USERVER_NAMESPACE::formats::json::parser::ParseToType<
        OneOfDiscriminator,
        USERVER_NAMESPACE::chaotic::sax::impl::RemoveUserTypeParser<
            USERVER_NAMESPACE::chaotic::sax::Parser<OneOfDiscriminator>
        >
    >(json);
}
    ...
    USERVER_NAMESPACE::formats::serialize::To<USERVER_NAMESPACE::formats::json::Value>)
{
    ...
    if (value.foo) {
        vb["foo"] =
            USERVER_NAMESPACE::chaotic::OneOfWithDiscriminator<&::ns::OneOfDiscriminator::kFoo_Settings, USERVER_NAMESPACE::chaotic::Primitive<::ns::A>, USERVER_NAMESPACE::chaotic::Primitive<::ns::B>>{
                *value.foo
            };
    }
    ...
    [[maybe_unused]] std::string_view hide_field_name)
{
    ...
    if (value.foo && hide_field_name != "foo") {
        sw.Key("foo");
        WriteToStream(USERVER_NAMESPACE::chaotic::OneOfWithDiscriminator<&::ns::OneOfDiscriminator::kFoo_Settings, USERVER_NAMESPACE::chaotic::Primitive<::ns::A>, USERVER_NAMESPACE::chaotic::Primitive<::ns::B>>{
            *value.foo
        }, sw);
    }
}
