    ...
    USERVER_NAMESPACE::formats::parse::To<Circle>)
{
    return USERVER_NAMESPACE::formats::json::parser::ParseToType<
        ...
        USERVER_NAMESPACE::chaotic::sax::impl::RemoveUserTypeParser<
            USERVER_NAMESPACE::chaotic::sax::Parser<Circle>
        >
    >(json);
}
...
Circle Parse(
    ...
    USERVER_NAMESPACE::formats::parse::To<Circle> to)
{
    ...
    [[maybe_unused]] std::string_view hide_field_name)
{
    ...
    if (value.radius && hide_field_name != "radius") {
        sw.Key("radius");
        WriteToStream(USERVER_NAMESPACE::chaotic::Primitive<double>{
            *value.radius
        }, sw);
    }
    ...
    USERVER_NAMESPACE::formats::parse::To<Object>)
{
    return USERVER_NAMESPACE::formats::json::parser::ParseToType<
        Object,
        USERVER_NAMESPACE::chaotic::sax::impl::RemoveUserTypeParser<
            USERVER_NAMESPACE::chaotic::sax::Parser<Object>
        >
    >(json);
}
...
Object Parse(
    USERVER_NAMESPACE::formats::json::Value json,
    USERVER_NAMESPACE::formats::parse::To<Object> to)
{
    return Parse<USERVER_NAMESPACE::formats::json::Value>(json, to);
}
    ...
    USERVER_NAMESPACE::formats::parse::To<ObjectCpp>)
{
    return USERVER_NAMESPACE::formats::json::parser::ParseToType<
        ObjectCpp,
        USERVER_NAMESPACE::chaotic::sax::impl::RemoveUserTypeParser<
            USERVER_NAMESPACE::chaotic::sax::Parser<ObjectCpp>
        >
    >(json);
}
...
bool operator==(const ObjectCpp & lhs,const ObjectCpp & rhs) {
    return true
        && lhs.some_hyphenated_key == rhs.some_hyphenated_key
    ;
}
...
ObjectCpp Parse(
    USERVER_NAMESPACE::formats::json::Value json,
    USERVER_NAMESPACE::formats::parse::To<ObjectCpp> to)
{
    return Parse<USERVER_NAMESPACE::formats::json::Value>(json, to);
}
    ...
    USERVER_NAMESPACE::formats::serialize::To<USERVER_NAMESPACE::formats::json::Value>)
{
    ...
    if (value.some_hyphenated_key) {
        vb["some-hyphenated-key"] =
            USERVER_NAMESPACE::chaotic::Primitive<std::string>{
                *value.some_hyphenated_key
            };
    }
    ...
    USERVER_NAMESPACE::formats::parse::To<Rectangle>)
{
    return USERVER_NAMESPACE::formats::json::parser::ParseToType<
        Rectangle,
        USERVER_NAMESPACE::chaotic::sax::impl::RemoveUserTypeParser<
            USERVER_NAMESPACE::chaotic::sax::Parser<Rectangle>
        >
    >(json);
}
...
Rectangle Parse(
    USERVER_NAMESPACE::formats::json::Value json,
    USERVER_NAMESPACE::formats::parse::To<Rectangle> to)
{
    return Parse<USERVER_NAMESPACE::formats::json::Value>(json, to);
}
...
Status Parse(
    USERVER_NAMESPACE::formats::json::Value json,
    USERVER_NAMESPACE::formats::parse::To<Status> to)
{
    return Parse<USERVER_NAMESPACE::formats::json::Value>(json, to);
}
...
void WriteToStream(
    [[maybe_unused]] const Status& value,
    USERVER_NAMESPACE::formats::json::StringBuilder& sw)
{
    ...
    USERVER_NAMESPACE::formats::parse::To<TreeNode>)
{
    return USERVER_NAMESPACE::formats::json::parser::ParseToType<
        TreeNode,
        USERVER_NAMESPACE::chaotic::sax::impl::RemoveUserTypeParser<
            USERVER_NAMESPACE::chaotic::sax::Parser<TreeNode>
        >
    >(json);
}
...
TreeNode Parse(
    USERVER_NAMESPACE::formats::json::Value json,
    USERVER_NAMESPACE::formats::parse::To<TreeNode> to)
{
    return Parse<USERVER_NAMESPACE::formats::json::Value>(json, to);
}
    ...
    [[maybe_unused]] std::string_view hide_field_name)
{
    ...
    if (value.left && hide_field_name != "left") {
        sw.Key("left");
        WriteToStream(USERVER_NAMESPACE::chaotic::Ref<USERVER_NAMESPACE::chaotic::Primitive<::ns::TreeNode>>{
            *value.left
        }, sw);
    }
...
fmt::format_context::iterator fmt::formatter<ns::Status>::format(const ns::Status& value, fmt::format_context& ctx) const {
