...
constexpr USERVER_NAMESPACE::utils::TrivialSet k__ns__OneOf_PropertiesNames = [](auto selector) {
    ...
    USERVER_NAMESPACE::formats::parse::To<OneOf>)
{
    ...
    OneOf res{
        .foo = value["foo"].template As<
            std::optional<USERVER_NAMESPACE::chaotic::Variant<USERVER_NAMESPACE::chaotic::Primitive<int>,USERVER_NAMESPACE::chaotic::Primitive<std::string>>>
        >(),
    };

    USERVER_NAMESPACE::chaotic::ValidateNoAdditionalProperties(
        value, k__ns__OneOf_PropertiesNames
    );
