...
bool operator==(const ::ns::OneOf& lhs, const ::ns::OneOf& rhs) { return lhs.foo == rhs.foo && true; }
...
OneOf Parse(USERVER_NAMESPACE::formats::json::Value json, USERVER_NAMESPACE::formats::parse::To<::ns::OneOf> to) {
    return Parse<USERVER_NAMESPACE::formats::json::Value>(json, to);
}

OneOf Parse(USERVER_NAMESPACE::formats::yaml::Value json, USERVER_NAMESPACE::formats::parse::To<::ns::OneOf> to) {
    return Parse<USERVER_NAMESPACE::formats::yaml::Value>(json, to);
}

OneOf Parse(USERVER_NAMESPACE::yaml_config::Value json, USERVER_NAMESPACE::formats::parse::To<::ns::OneOf> to) {
