...
inline USERVER_NAMESPACE::utils::datetime::TimePointTz
Convert(const CustomDateTime& lhs, USERVER_NAMESPACE::chaotic::convert::To<USERVER_NAMESPACE::utils::datetime::TimePointTz>) {
