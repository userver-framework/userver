...
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::optional<std::uint8_t>> val);
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::int8_t> val);
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::optional<std::int8_t>> val);

void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::uint16_t> val);
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::optional<std::uint16_t>> val);
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::int16_t> val);
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::optional<std::int16_t>> val);

void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::uint32_t> val);
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::optional<std::uint32_t>> val);
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::int32_t> val);
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::optional<std::int32_t>> val);

void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::uint64_t> val);
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::optional<std::uint64_t>> val);
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::int64_t> val);
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::optional<std::int64_t>> val);

void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<float> val);
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::optional<float>> val);
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<double> val);
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::optional<double>> val);

void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::string> val);
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::optional<std::string>> val);

void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<formats::json::Value> val);
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::optional<formats::json::Value>> val);
...
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<Date> val);
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::optional<Date>> val);
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<DateTime> val);
void FreestandingBind(OutputBindingsFwd& binds, std::size_t pos, ExplicitRef<std::optional<DateTime>> val);
...
void FreestandingBind(InputBindingsFwd& binds, std::size_t pos, ExplicitCRef<Date> val);
void FreestandingBind(InputBindingsFwd& binds, std::size_t pos, ExplicitCRef<DateTime> val);
...
void FreestandingBind(InputBindingsFwd& binds, std::size_t pos, ExplicitCRef<std::optional<T>> val) {
    if (val.Get().has_value()) {
        storages::mysql::impl::io::FreestandingBind(binds, pos, ExplicitCRef<T>{*val.Get()});
    } else {
