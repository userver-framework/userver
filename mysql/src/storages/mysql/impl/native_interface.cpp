...
int NativeInterface::StatementPrepare(MYSQL_STMT* stmt, const char* stmt_str, std::size_t length) && {
    ...
    socket_.RunToCompletion(
        [&err, stmt, stmt_str, length] { return mysql_stmt_prepare_start(&err, stmt, stmt_str, length); },
        [&err, stmt](int mysql_events) { return mysql_stmt_prepare_cont(&err, stmt, mysql_events); },
        deadline_
    );
...
int NativeInterface::StatementExecute(MYSQL_STMT* stmt) && {
    ...
    socket_.RunToCompletion(
        ...
        [&err, stmt](int mysql_events) { return mysql_stmt_execute_cont(&err, stmt, mysql_events); },
        deadline_
    );
...
int NativeInterface::StatementStoreResult(MYSQL_STMT* stmt) && {
    ...
    socket_.RunToCompletion(
        ...
        [&err, stmt](int mysql_events) { return mysql_stmt_store_result_cont(&err, stmt, mysql_events); },
        deadline_
    );
...
int NativeInterface::StatementFetch(MYSQL_STMT* stmt) && {
    ...
    socket_.RunToCompletion(
        ...
        [&err, stmt](int mysql_events) { return mysql_stmt_fetch_cont(&err, stmt, mysql_events); },
        deadline_
    );
...
my_bool NativeInterface::StatementFreeResult(MYSQL_STMT* stmt) && {
    ...
    socket_.RunToCompletion(
        ...
        [&err, stmt](int mysql_events) { return mysql_stmt_free_result_cont(&err, stmt, mysql_events); },
        deadline_
    );
...
my_bool NativeInterface::StatementClose(MYSQL_STMT* stmt) && {
    ...
    socket_.RunToCompletion(
        ...
        [&err, stmt](int mysql_events) { return mysql_stmt_close_cont(&err, stmt, mysql_events); },
        deadline_
    );
...
int NativeInterface::QueryExecute(MYSQL* mysql, const char* stmt_str, std::size_t length) && {
    int err = 0;
    socket_.RunToCompletion(
        [&err, mysql, stmt_str, length] { return mysql_real_query_start(&err, mysql, stmt_str, length); },
        [&err, mysql](int mysql_events) { return mysql_real_query_cont(&err, mysql, mysql_events); },
        deadline_
    );
...
MYSQL_RES* NativeInterface::QueryStoreResult(MYSQL* mysql) && {
    ...
    socket_.RunToCompletion(
        ...
        [&result, mysql](int mysql_events) { return mysql_store_result_cont(&result, mysql, mysql_events); },
        deadline_
    );
...
MYSQL_ROW NativeInterface::QueryResultFetchRow(MYSQL_RES* result) && {
    ...
    socket_.RunToCompletion(
        ...
        [&row, result](int mysql_events) { return mysql_fetch_row_cont(&row, result, mysql_events); },
        deadline_
    );
...
void NativeInterface::QueryFreeResult(MYSQL_RES* result) && {
    socket_.RunToCompletion(
        [result] { return mysql_free_result_start(result); },
        [result](int mysql_events) { return mysql_free_result_cont(result, mysql_events); },
        deadline_
    );
}
...
int NativeInterface::Ping(MYSQL* mysql) && {
    ...
    socket_.RunToCompletion(
        ...
        [&err, mysql](int mysql_events) { return mysql_ping_cont(&err, mysql, mysql_events); },
        deadline_
    );
...
my_bool NativeInterface::Commit(MYSQL* mysql) && {
    ...
    socket_.RunToCompletion(
        ...
        [&err, mysql](int mysql_events) { return mysql_commit_cont(&err, mysql, mysql_events); },
        deadline_
    );
...
my_bool NativeInterface::Rollback(MYSQL* mysql) && {
    ...
    socket_.RunToCompletion(
        ...
        [&err, mysql](int mysql_events) { return mysql_rollback_cont(&err, mysql, mysql_events); },
        deadline_
    );
...
void NativeInterface::Close(MYSQL* mysql) && {
    try {
        socket_.RunToCompletion(
            [mysql] { return mysql_close_start(mysql); },
            [mysql](int mysql_event) { return mysql_close_cont(mysql, mysql_event); },
            deadline_
        );
