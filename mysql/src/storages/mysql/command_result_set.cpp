...
const std::string& CommandResultSet::At(std::size_t row, std::size_t column) const { return impl_->At(row, column); }

std::string& CommandResultSet::At(std::size_t row, std::size_t column) { return impl_->At(row, column); }
