...
struct Inet {
    ...
    Inet() = default;
    explicit Inet(std::string t) : text(std::move(t)) {}
...
public:
    ...
    Value(std::int8_t v) : storage_(v) {}
    Value(std::int16_t v) : storage_(v) {}
    Value(std::int32_t v) : storage_(v) {}
    Value(std::int64_t v) : storage_(v) {}
    Value(float v) : storage_(v) {}
    Value(double v) : storage_(v) {}

    Value(Uuid v) : storage_(v) {}
    Value(Timestamp v) : storage_(v) {}
    Value(Date v) : storage_(v) {}
    Value(Time v) : storage_(v) {}
    Value(Blob v) : storage_(std::move(v)) {}
    Value(Inet v) : storage_(std::move(v)) {}
...
inline Value::Value(List v) : storage_(std::make_shared<List>(std::move(v))) {}
inline Value::Value(Map v) : storage_(std::make_shared<Map>(std::move(v))) {}
inline Value::Value(Set v) : storage_(std::make_shared<Set>(std::move(v))) {}
