...
using array_of_vectors_of_unordered_sets = std::array<vector_of_unordered_sets, kDimOne>;
...
static_assert((std::is_same<tt::ContainerFinalElement<one_dim_vector>::type, Int>::value));
static_assert((std::is_same<tt::ContainerFinalElement<two_dim_vector>::type, Int>::value));
static_assert(std::is_same<tt::ContainerFinalElement<three_dim_vector>::type, Int>::value);

static_assert((std::is_same<tt::ContainerFinalElement<one_dim_array>::type, Int>::value));
static_assert((std::is_same<tt::ContainerFinalElement<two_dim_array>::type, Int>::value));
static_assert(std::is_same<tt::ContainerFinalElement<three_dim_array>::type, Int>::value);

static_assert(std::is_same<tt::ContainerFinalElement<vector_of_arrays>::type, Int>::value);

static_assert(std::is_same<tt::ContainerFinalElement<unordered_set>::type, Int>::value);
static_assert(std::is_same<tt::ContainerFinalElement<vector_of_unordered_sets>::type, Int>::value);
static_assert(std::is_same<tt::ContainerFinalElement<array_of_vectors_of_unordered_sets>::type, Int>::value);

static_assert(std::is_same<tt::ContainerFinalElement<one_dim_set>::type, Int>::value);
static_assert(std::is_same<tt::ContainerFinalElement<two_dim_set>::type, Int>::value);
static_assert(std::is_same<tt::ContainerFinalElement<set_of_arrays>::type, Int>::value);
static_assert(std::is_same<tt::ContainerFinalElement<set_of_vectors>::type, Int>::value);
...
static_assert(tt::kTypeBufferCategory<one_dim_vector> == io::BufferCategory::kArrayBuffer);
static_assert(tt::kTypeBufferCategory<two_dim_vector> == io::BufferCategory::kArrayBuffer);
static_assert(tt::kTypeBufferCategory<three_dim_vector> == io::BufferCategory::kArrayBuffer);

static_assert(tt::kTypeBufferCategory<one_dim_array> == io::BufferCategory::kArrayBuffer);
static_assert(tt::kTypeBufferCategory<two_dim_array> == io::BufferCategory::kArrayBuffer);
static_assert(tt::kTypeBufferCategory<three_dim_array> == io::BufferCategory::kArrayBuffer);

static_assert(tt::kTypeBufferCategory<vector_of_arrays> == io::BufferCategory::kArrayBuffer);

static_assert(tt::kTypeBufferCategory<unordered_set> == io::BufferCategory::kArrayBuffer);
static_assert(tt::kTypeBufferCategory<vector_of_unordered_sets> == io::BufferCategory::kArrayBuffer);
static_assert(tt::kTypeBufferCategory<array_of_vectors_of_unordered_sets> == io::BufferCategory::kArrayBuffer);

static_assert(tt::kTypeBufferCategory<one_dim_set> == io::BufferCategory::kArrayBuffer);
static_assert(tt::kTypeBufferCategory<two_dim_set> == io::BufferCategory::kArrayBuffer);
static_assert(tt::kTypeBufferCategory<set_of_arrays> == io::BufferCategory::kArrayBuffer);
static_assert(tt::kTypeBufferCategory<set_of_vectors> == io::BufferCategory::kArrayBuffer);
...
static_assert(
    io::CppToPg<one_dim_vector>::GetOid(types) ==
    static_cast<unsigned int>(io::PredefinedOid<io::PredefinedOids::kInt4Array>::value)
);
static_assert(
    io::CppToPg<two_dim_vector>::GetOid(types) ==
    static_cast<unsigned int>(io::PredefinedOid<io::PredefinedOids::kInt4Array>::value)
);
static_assert(
    io::CppToPg<three_dim_vector>::GetOid(types) ==
    static_cast<unsigned int>(io::PredefinedOid<io::PredefinedOids::kInt4Array>::value)
);

static_assert(
    io::CppToPg<one_dim_array>::GetOid(types) ==
    static_cast<unsigned int>(io::PredefinedOid<io::PredefinedOids::kInt4Array>::value)
);
static_assert(
    io::CppToPg<two_dim_array>::GetOid(types) ==
    static_cast<unsigned int>(io::PredefinedOid<io::PredefinedOids::kInt4Array>::value)
);
static_assert(
    io::CppToPg<three_dim_array>::GetOid(types) ==
    static_cast<unsigned int>(io::PredefinedOid<io::PredefinedOids::kInt4Array>::value)
);

static_assert(
    io::CppToPg<vector_of_arrays>::GetOid(types) ==
    static_cast<unsigned int>(io::PredefinedOid<io::PredefinedOids::kInt4Array>::value)
);

static_assert(
    io::CppToPg<unordered_set>::GetOid(types) ==
    static_cast<unsigned int>(io::PredefinedOid<io::PredefinedOids::kInt4Array>::value)
);
static_assert(
    io::CppToPg<vector_of_unordered_sets>::GetOid(types) ==
    static_cast<unsigned int>(io::PredefinedOid<io::PredefinedOids::kInt4Array>::value)
);
static_assert(
    io::CppToPg<array_of_vectors_of_unordered_sets>::GetOid(types) ==
    static_cast<unsigned int>(io::PredefinedOid<io::PredefinedOids::kInt4Array>::value)
);

static_assert(
    io::CppToPg<one_dim_set>::GetOid(types) ==
    static_cast<unsigned int>(io::PredefinedOid<io::PredefinedOids::kInt4Array>::value)
);
static_assert(
    io::CppToPg<two_dim_set>::GetOid(types) ==
    static_cast<unsigned int>(io::PredefinedOid<io::PredefinedOids::kInt4Array>::value)
);
static_assert(
    io::CppToPg<set_of_arrays>::GetOid(types) ==
    static_cast<unsigned int>(io::PredefinedOid<io::PredefinedOids::kInt4Array>::value)
);
static_assert(
    io::CppToPg<set_of_vectors>::GetOid(types) ==
    static_cast<unsigned int>(io::PredefinedOid<io::PredefinedOids::kInt4Array>::value)
);
...
static_assert(io::IsTypeMappedToSystemArray<array_of_vectors_of_unordered_sets>());
...
pg::io::TypeBufferCategory GetTestTypeCategories() {
    ...
    for (auto p_oid : {Oids::kInt2, Oids::kInt2Array, Oids::kInt4, Oids::kInt4Array, Oids::kInt8, Oids::kInt8Array}) {
...
TEST(PostgreIO, Arrays) {
    const pg::io::TypeBufferCategory categories = GetTestTypeCategories();
    {
        ...
        auto fb = pg::test::MakeFieldBuffer(buffer, io::BufferCategory::kArrayBuffer);
...
TEST(PostgreIO, ArraysSet) {
    ...
    }
    {
        ...
        EXPECT_FALSE(buffer.empty());
        auto fb = pg::test::MakeFieldBuffer(buffer, io::BufferCategory::kArrayBuffer);
        const static_test::one_dim_set expected(src.begin(), src.end());
        static_test::one_dim_set tgt;
        UEXPECT_NO_THROW(io::ReadBuffer(fb, tgt, categories));
...
TEST(PostgreIO, ArraysUnorderedSet) {
    ...
    {
        using test_array_of_vectors_of_unordered_sets = static_test::array_of_vectors_of_unordered_sets;
    ...
    }
    {
        ...
        EXPECT_FALSE(buffer.empty());
        auto fb = pg::test::MakeFieldBuffer(buffer, io::BufferCategory::kArrayBuffer);
        const static_test::unordered_set expected(src.begin(), src.end());
        static_test::unordered_set tgt;
        UEXPECT_NO_THROW(io::ReadBuffer(fb, tgt, categories));
        EXPECT_EQ(tgt, expected);
    }
...
UTEST_P(PostgreConnection, ArrayRoundtrip) {
    ...
    }
    {
        ...
        test_array src{{}, nullable_type{"foo"}, nullable_type{"bar"}, nullable_type{""}};
        UEXPECT_NO_THROW(res = GetConn()->Execute("select $1 as text_array_with_nulls", src));
        test_array tgt;
        UEXPECT_NO_THROW(res[0][0].To(tgt));
    ...
    }
    {
        ...
        test_array src{};
        UEXPECT_NO_THROW(res = GetConn()->Execute("select $1 as text_2d_array", src));
        test_array tgt;
        UEXPECT_NO_THROW(res[0][0].To(tgt));
        UEXPECT_THROW(res[0][0].As<std::string>(), pg::InvalidParserCategory);
        EXPECT_EQ(src, tgt);
...
UTEST_P(PostgreConnection, ArraySetRoundtrip) {
    ...
    }
    {
        ...
        UEXPECT_NO_THROW(res[0][0].To(tgt));
        UEXPECT_THROW(res[0][0].As<std::string>(), pg::InvalidParserCategory);
        const std::set<std::string> expected(src.begin(), src.end());
        EXPECT_EQ(tgt, expected);
    }
    {
        using nullable_type = std::optional<std::string>;
...
UTEST_P(PostgreConnection, ArrayUnorderedSetRoundtrip) {
    ...
    }
    {
        ...
        UEXPECT_NO_THROW(res[0][0].To(tgt));
        UEXPECT_THROW(res[0][0].As<std::string>(), pg::InvalidParserCategory);
        const std::unordered_set<std::string> expected(src.begin(), src.end());
        EXPECT_EQ(tgt, expected);
    }
    {
        using nullable_type = std::optional<std::string>;
...
UTEST_P(PostgreConnection, ArrayEmpty) {
    ...
    {
        UEXPECT_NO_THROW(res = GetConn()->Execute("select $1 as array", static_test::one_dim_vector{}));
        static_test::one_dim_vector v{1};
        UEXPECT_NO_THROW(res[0].To(v));
        EXPECT_TRUE(v.empty());
    }
...
UTEST_P(PostgreConnection, ArrayOfBool) {
    ...
    pg::ResultSet res{nullptr};
    UEXPECT_NO_THROW(res = GetConn()->Execute("select $1::boolean[]", std::vector<bool>{true, false, true}));
    std::vector<bool> tgt;
    UEXPECT_NO_THROW(res[0][0].To(tgt));
    EXPECT_EQ(src, tgt);
}
...
void CheckSplit(const io::detail::ContainerSplitter<std::vector<int>>& split) {
    ...
    auto expected_chunks = data.size() / split.ChunkSize() + (data.size() % split.ChunkSize() ? 1 : 0);
...
UTEST_P(PostgreConnection, ChunkedContainer) {
    ...
    const std::vector<int> data(1001, 42);
    auto split = io::SplitContainer(data, 100);
    for (auto chunk : split) {
        UEXPECT_NO_THROW(GetConn()->Execute("insert into chunked_array_test select * from unnest($1)", chunk));
    }
...
UTEST_P(PostgreConnection, TransactionChunkedContainer) {
    ...
    UEXPECT_NO_THROW(trx.ExecuteBulk("insert into chunked_array_test select * from unnest($1)", data, 100));
...
void InsertDecomposedInChunks(pg::Transaction& trx, const std::vector<IdAndValue>& rows) {
...
/// [ExecuteDecomposeTrx]
auto InsertDecomposedArrayInTrx(pg::Transaction& trx, const std::vector<IdAndValue>& rows) {
    return trx.ExecuteDecompose(
        "INSERT INTO decomposed_array_test(id, value) "
        "VALUES(UNNEST($1), UNNEST($2)) RETURNING *",
        rows
    );
}
/// [ExecuteDecomposeTrx]
...
UTEST_P(PostgreConnection, TransactionDecomposedChunkedContainer) {
    ...
    for (std::size_t i = 0; i < rows_to_insert.size(); ++i) {
        const auto eq = [](const auto& lhs, const auto& rhs) { return lhs.id == rhs.id && lhs.value == rhs.value; };
...
UTEST_P(PostgreConnection, TransactionDecomposedContainer) {
    CheckConnection(GetConn());

    GetConn()->Execute(
        "create temporary table decomposed_array_test("
        "id integer, value text)"
    );
    ...
    const auto inserted_rows =
        InsertDecomposedArrayInTrx(trx, rows_to_insert).AsContainer<std::vector<IdAndValue>>(pg::kRowTag);
