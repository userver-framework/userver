...
template <>
struct BufferParser<DBTypeDescription::TypeClass> : detail::CharToEnum<DBTypeDescription::TypeClass> {
    using BaseType = detail::CharToEnum<DBTypeDescription::TypeClass>;
    using BaseType::BaseType;
};

template <>
struct BufferParser<DBTypeDescription::TypeCategory> : detail::CharToEnum<DBTypeDescription::TypeCategory> {
...
template <>
struct BufferFormatter<std::uint16_t> : detail::BufferFormatterBase<std::uint16_t> {
