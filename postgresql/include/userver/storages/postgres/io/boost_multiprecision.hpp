...
template <unsigned Precision>
struct BufferParser<MultiPrecision<Precision>> : detail::BufferParserBase<MultiPrecision<Precision>> {
...
template <unsigned Precision>
struct CppToSystemPg<MultiPrecision<Precision>> : PredefinedOid<PredefinedOids::kNumeric> {};
