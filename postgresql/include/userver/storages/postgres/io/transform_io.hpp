...
template <typename UserType, typename WireType, typename Converter, bool Categories>
...
struct TransformParserBase<UserType, WireType, Converter, true> : BufferParserBase<UserType> {
    using BaseType = BufferParserBase<UserType>;
    using BaseType::BaseType;
...
struct TransformParser
    : detail::TransformParserBase<UserType, WireType, Converter, detail::kParserRequiresTypeCategories<WireType>> {
    using BaseType =
        detail::TransformParserBase<UserType, WireType, Converter, detail::kParserRequiresTypeCategories<WireType>>;
    using BaseType::BaseType;
};
