...
///
/// A generated enum:
/// @snippet postgresql/src/storages/postgres/tests/enums_pgtest.cpp autogenerated enum type postgres
/// can be registered in the following way
/// @snippet postgresql/src/storages/postgres/tests/enums_pgtest.cpp autogenerated enum registration postgres
///
...
/// Use it as usual:
/// @snippet postgresql/src/storages/postgres/tests/enums_pgtest.cpp autogenerated enum usage postgres
struct Codegen {};
...
struct EnumConverter {
    using PostgresType = std::string;
    using UserType = Enum;

    Enum operator()(const PostgresType& db_data) const { return Parse(db_data, formats::parse::To<Enum>()); }
...
// Specialization for enum parsing using ToString function
...
// Specialization for enum formatting using Parse functions
