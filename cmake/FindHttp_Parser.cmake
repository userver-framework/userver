...
if (HTTP_PARSER_FOUND)
    ...
    set(Http_Parser_FOUND True)

    if(NOT TARGET Http_Parser)
      add_library(Http_Parser INTERFACE IMPORTED)
    endif()
    set_property(TARGET Http_Parser PROPERTY INTERFACE_INCLUDE_DIRECTORIES "${HTTP_PARSER_INCLUDE_DIR}")
    set_property(TARGET Http_Parser PROPERTY INTERFACE_LINK_LIBRARIES "${HTTP_PARSER_LIBRARY}")
endif()
