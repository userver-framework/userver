...
if(IWYU_ENABLED)
    ...
    if(IWYU_VERSION VERSION_LESS IWYU_VERSION_REQUIRED)
        message(
            FATAL_ERROR "IWYU ${IWYU_PATH} version too low (${IWYU_VERSION}), must be at least ${IWYU_VERSION_REQUIRED}"
        )
    endif()

    set(IWYU_ARGS "-Xiwyu;--cxx17ns" "-Xiwyu;--no_comments" "-Xiwyu;--no_fwd_decls")
