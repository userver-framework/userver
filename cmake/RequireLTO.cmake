...
elseif(NOT USERVER_USE_LD MATCHES "lld")
    ...
    if(USERVER_LTO_CACHE_SIZE_MB)
        set(CMAKE_SHARED_LINKER_FLAGS
            "${CMAKE_SHARED_LINKER_FLAGS} -Wl,--thinlto-cache-policy,cache_size_bytes=${USERVER_LTO_CACHE_SIZE_MB}m:cache_size=0%:prune_interval=5m"
        )
        set(CMAKE_EXE_LINKER_FLAGS
            "${CMAKE_EXE_LINKER_FLAGS} -Wl,--thinlto-cache-policy,cache_size_bytes=${USERVER_LTO_CACHE_SIZE_MB}m:cache_size=0%:prune_interval=5m"
        )
    endif()
endif()

# check_ipo_supported() may not check linkage that may fail due to wrong linker. Using a more complex check.
