...
if(LTO)
    if(CUSTOM_LD_OK)
        ...
        find_program(LLVM_AR NAMES llvm-ar-9 llvm-ar HINTS ${LLVM_PATH_HINTS})
        find_program(LLVM_RANLIB NAMES llvm-ranlib-9 llvm-ranlib HINTS ${LLVM_PATH_HINTS})
        if (NOT LLVM_AR)
            set(LTO OFF)
            set(LTO_DISABLE_REASON "llvm-ar (from llvm-9) not found")
        elseif(NOT LLVM_RANLIB)
            set(LTO OFF)
            set(LTO_DISABLE_REASON "llvm-ranlib (from llvm-9) not found")
        endif()
    else(CUSTOM_LD_OK)
        set(LTO OFF)
