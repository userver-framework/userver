...
if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU" AND ${Boost_VERSION} VERSION_LESS "1.66")
  ...
  message(STATUS "DWCAS 1")
else()
  set(LIBATOMIC_FLAG)
  message(STATUS "DWCAS 2")
endif()

message(STATUS "DWCAS 3 id=${CMAKE_CXX_COMPILER_ID} ver=${Boost_VERSION}")
...
try_run(
  ...
  COMPILE_DEFINITIONS ${MCX16_ARG} ${LIBATOMIC_FLAG}
