# File from libgit2
#
# https://github.com/libgit2/libgit2/blob/master/cmake/Modules/FindGSSAPI.cmake
#
# - Try to find GSSAPI
...
if(GSSAPI_FOUND)
  if (NOT TARGET GssApi)
    add_library(GssApi INTERFACE IMPORTED)
    set_property(TARGET GssApi 
      PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${GSSAPI_INCLUDE_DIRS})
    set_property(TARGET GssApi 
      PROPERTY INTERFACE_LINK_LIBRARIES ${GSSAPI_LIBRARIES})
  endif()
endif(GSSAPI_FOUND)
