...
function(write_package_stub PACKAGE_NAME)
    ...
    # CPM package names often differ from find_package() names (e.g. abseil-cpp vs absl).
    # A stub in CMAKE_PREFIX_PATH/package_stubs/ (see UserverSetupEnvironment.cmake)
    # makes nested find_package() succeed without pulling a second copy from the system.
    file(MAKE_DIRECTORY "${CMAKE_BINARY_DIR}/package_stubs")
    file(WRITE "${CMAKE_BINARY_DIR}/package_stubs/${PACKAGE_NAME}Config.cmake"
         "# Stub: ${PACKAGE_NAME} is provided by CPM; targets are already defined.\n"
