...
public:
    ...
    HttpClientException(int code, const LocalStats& stats, std::string_view message);
...
public:
    ...
    HttpServerException(int code, const LocalStats& stats, std::string_view message);
