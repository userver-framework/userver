...
public:
    explicit TagScope(
        ...
        logging::LogExtra::ExtendType extend_type = logging::LogExtra::ExtendType::kNormal
    );
...
private:
    ...
    std::vector<std::pair<std::size_t, logging::LogExtra::ProtectedValue>> previous_values_;
};
