...
/// @param schema_hash SHA-256(canonical JSON of schema), lowercase hex,
///        produced by chaotic codegen. Empty for keys not generated by
///        chaotic.
ConfigId Register(
    std::string&& name,
    Factory factory,
...
/// @brief Returns metadata of every Key registered in this binary.
