...
class CachedTranslations final : public components::CachingComponentBase<KeyTranslation> {
public:
...
class LruCachedTranslations final : public cache::LruCacheComponent<std::string, std::string> {
public:
