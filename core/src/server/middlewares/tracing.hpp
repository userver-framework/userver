...
public:
    ...
    Tracing(const tracing::TracingManagerBase& tracing_manager, const handlers::HttpHandlerBase& handler);
...
public:
    ...
    TracingFactory(const components::ComponentConfig&, const components::ComponentContext&);
...
template <>
inline constexpr bool components::kHasValidate<server::middlewares::TracingFactory> = true;

template <>
inline constexpr auto components::kConfigFileMode<server::middlewares::TracingFactory> = ConfigFileMode::kNotRequired;
