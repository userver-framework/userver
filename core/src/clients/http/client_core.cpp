...
InstanceStatistics ClientCore::GetMultiStatistics(size_t n) const {
...
PoolStatistics ClientCore::GetPoolStatistics() const {
...
const DestinationStatistics& ClientCore::GetDestinationStatistics() const { return *destination_statistics_; }
