...
using Percentile = utils::statistics::Percentile<
    /*buckets =*/2000,
    unsigned int,
    /*extra_buckets=*/1180,
...
public:
    ...
    static constexpr auto kErrorGroupCount = static_cast<std::size_t>(Statistics::ErrorGroup::kCount);
...
private:
    ...
    utils::statistics::RecentPeriod<Percentile, Percentile, utils::datetime::SteadyClock> timings_percentile_;
