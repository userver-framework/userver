...
template <>
struct is_error_code_enum<USERVER_NAMESPACE::curl::errc::EasyErrorCode> : std::true_type {};

template <>
struct is_error_code_enum<USERVER_NAMESPACE::curl::errc::MultiErrorCode> : std::true_type {};
