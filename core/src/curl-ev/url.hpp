...
#define IMPLEMENT_CURLU_PART_GET_F(FUNCTION_NAME, OPTION_NAME, FLAGS)                                      \
    ...
    inline impl::CurlPtr FUNCTION_NAME(std::error_code& ec) const {                                        \
        char* part = nullptr;                                                                              \
        ec = static_cast<errc::UrlErrorCode>(native::curl_url_get(url_.get(), OPTION_NAME, &part, FLAGS)); \
...
#define IMPLEMENT_CURLU_PART_SET(FUNCTION_NAME, OPTION_NAME) \
    IMPLEMENT_CURLU_PART_SET_F(FUNCTION_NAME, OPTION_NAME, CURLU_PATH_AS_IS)
...
public:
    ...
    IMPLEMENT_CURLU_PART_GET_F(GetPortPtr, native::CURLUPART_PORT, CURLU_DEFAULT_PORT);
