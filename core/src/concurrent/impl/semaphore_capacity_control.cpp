...
auto SemaphoreCapacityControl::GetCapacity() const noexcept -> Counter { return capacity_requested_.load(); }
...
void SemaphoreCapacityControl::UpdateSemaphoreCapacity() const {
    ...
    auto capacity = capacity_override == kOverrideDisabled ? capacity_base : capacity_override;
