...
BENCHMARK_TEMPLATE(ReadIndicatorLockUnlock, SimpleRefcount)->RangeMultiplier(2)->Range(1, 32);
BENCHMARK_TEMPLATE(ReadIndicatorLockUnlock, concurrent::impl::StripedReadIndicator)->RangeMultiplier(2)->Range(1, 32);
...
BENCHMARK_TEMPLATE(ReadIndicatorIsFree, SimpleRefcount)->RangeMultiplier(2)->Range(1, 32);
BENCHMARK_TEMPLATE(ReadIndicatorIsFree, concurrent::impl::StripedReadIndicator)->RangeMultiplier(2)->Range(1, 32);
