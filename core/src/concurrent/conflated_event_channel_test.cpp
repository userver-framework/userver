...
UTEST(ConflatedEventChannel, Publish) {
    ...
    auto subscription = conflated_channel.AddListener(&subscriber, "sub", &Subscriber::OnEvent);
...
UTEST(ConflatedEventChannel, PublishForManyListeners) {
    ...
    auto subscription1 = conflated_channel.AddListener(&subscriber1, "sub1", &Subscriber::OnEvent);
    auto subscription2 = conflated_channel.AddListener(&subscriber2, "sub2", &Subscriber::OnEvent);
...
UTEST(ConflatedEventChannel, UpdateAndListen) {
    ...
    auto subscription = conflated_channel.UpdateAndListen(&subscriber, "sub", &Subscriber::OnEvent);
    EXPECT_EQ(subscriber.times_called, 1);
