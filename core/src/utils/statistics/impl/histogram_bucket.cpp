...
void Add(Bucket* bucket_array, HistogramView other) { MutableView{bucket_array}.Add(other); }

void ResetMetric(Bucket* bucket_array) noexcept { MutableView{bucket_array}.Reset(); }

HistogramView MakeView(const Bucket* bucket_array) noexcept { return Access::MakeView(bucket_array); }
