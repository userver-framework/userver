...
void CheckCurrent(const utils::statistics::MinMaxAvg<int>& mma, int expected_min, int expected_max, int expected_avg) {
...
TEST(MinMaxAvg, ToJson) {
    auto value = formats::json::ValueBuilder(GetFilledMma<1, 2, 3>()).ExtractValue();
