...
UTEST_F(BaggageManagerTest, AddEntry) {
    ...
    baggage_manager_.AddEntry("key4", "value4", {{"PropertyKey6", {"PropertyValue6"}}, {"property7", {}}});
    ...
    baggage_manager_.AddEntry("key5", "value5", {{"property8", {}}, {"PropertyKey9", {"PropertyValue9"}}});

    const auto& last_baggage = baggage::BaggageManager::TryGetBaggage();
    EXPECT_NE(last_baggage, nullptr);
    ASSERT_EQ(
        last_baggage->ToString(),
        "key1=value1,key2=value2;property1;PropertyKey2"
        "=PropertyValue2;property3,key3=value3;property4;PropertyKey5=Prope"
    ...
    UEXPECT_THROW(baggage_manager_.AddEntry("key20", "value4", {}), baggage::BaggageException);
}
