...
inline const std::unordered_set<std::string> kAllowedKeys = {"key1", "key2", "key3", "key4", "key5", "key,5"};
}  // namespace
...
UTEST(Baggage, ValidHeader) {
    ...
    baggage->AddEntry("key4", "value4", {{"PropertyKey6", {"PropertyValue6"}}, {"property7", {}}});
    ASSERT_EQ(
        baggage->ToString(),
        "key1=value1,key2=value2;property1;PropertyKey2"
        "=PropertyValue2;property3,key3=value3;property4;PropertyKey5=Prope"
    ...
    baggage->AddEntry("key,5", "value,5", {{"property8", {}}, {"Property,Key9", {"Property,Value9"}}});
    ASSERT_EQ(
        baggage->ToString(),
        "key1=value1,key2=value2;property1;PropertyKey2"
        "=PropertyValue2;property3,key3=value3;property4;PropertyKey5=Prope"
...
UTEST(Baggage, InvalidKeys) {
    ...
    UEXPECT_THROW(
        baggage->AddEntry("key4=rew", "value4", {{"Property;Key=6", {"Property;Value6"}}, {"property,7", {}}}),
...
UTEST(Baggage, InvalidProperties) {
    std::string header = "key1=value1  ;; ==;  ;=,  key2=value2  ;==;pk=,key3=value3;;=pv";
...
UTEST(Parse, BaggageHeader) {
    ...
    ASSERT_EQ(std::nullopt, baggage::TryMakeBaggage(std::move(invalid_header), kAllowedKeys));
    ...
    auto baggage_with_spaces = baggage::TryMakeBaggage(std::move(header_with_spaces), kAllowedKeys);
    ASSERT_EQ(baggage_with_spaces->ToString(), "");
}

class UTestBaggage : public baggage::Baggage {
public:
    UTestBaggage(const std::unordered_set<std::string>& allowed_keys) : baggage::Baggage("", allowed_keys) {}
    void UTestTryMakeBaggageEntry() {
        ...
        ASSERT_EQ(entry->ToString(), "key3=value3;property4;PropertyKey5=PropertyValue5");
        ...
        std::string invalid_entry_str = "key3=;property4;PropertyKey5=PropertyValue5";
    ...
    static void UTestTryMakeBaggageProperty() {
        ...
        ASSERT_EQ(std::nullopt, UTestBaggage::TryMakeBaggageEntryProperty(invalid_property_str));
