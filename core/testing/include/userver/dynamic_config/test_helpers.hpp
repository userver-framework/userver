...
inline dynamic_config::Source GetDefaultSource() {
  return dynamic_config::impl::GetDefaultSource(DEFAULT_TAXI_CONFIG_FILENAME);
}
...
inline const dynamic_config::Snapshot& GetDefaultSnapshot() {
  return dynamic_config::impl::GetDefaultSnapshot(DEFAULT_TAXI_CONFIG_FILENAME);
}
...
inline dynamic_config::StorageMock MakeDefaultStorage(
  ...
  return dynamic_config::impl::MakeDefaultStorage(DEFAULT_TAXI_CONFIG_FILENAME,
                                                  overrides);
}
#endif
