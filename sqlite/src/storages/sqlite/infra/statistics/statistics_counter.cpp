...
TransactionStatCounter::TransactionStatCounter(
    PoolTransactionsStatistics& stats)
    : transations_stats_{stats} {}
...
void TransactionStatCounter::AccountTransactionRollback() noexcept {
  ++transations_stats_.rollback;
}
