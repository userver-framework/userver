...
struct OptionalPrimitiveTraits {
    static std::optional<typename PrimitiveTrait::Type> Parse(NYdb::TValueParser& parser, const ParseContext& context);
...
template <>
struct ValueTraits<std::optional<DoubleTrait::Type>> : OptionalPrimitiveTraits<DoubleTrait> {};

template <>
struct ValueTraits<DoubleTrait::Type> : PrimitiveTraits<DoubleTrait> {};

template <>
struct ValueTraits<std::optional<Uint64Trait::Type>> : OptionalPrimitiveTraits<Uint64Trait> {};

template <>
struct ValueTraits<Uint64Trait::Type> : PrimitiveTraits<Uint64Trait> {};

template <>
struct ValueTraits<std::optional<Int64Trait::Type>> : OptionalPrimitiveTraits<Int64Trait> {};
...
template <>
struct ValueTraits<std::optional<Int32Trait::Type>> : OptionalPrimitiveTraits<Int32Trait> {};
