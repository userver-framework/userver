...
struct ValueTraits {
    ...
    static T Parse([[maybe_unused]] NYdb::TValueParser& parser, [[maybe_unused]] const ParseContext& context) {
        static_assert(
            !sizeof(T),
    ...
    static void Write([[maybe_unused]] NYdb::TValueBuilderBase<Builder>& builder, [[maybe_unused]] const T& value) {
        static_assert(
            !sizeof(T),
