...
void DumpMetric(utils::statistics::Writer& writer, const StatsAggregator& stats);

struct Stats final {
    Stats(utils::span<const double> by_database_histogram_bounds, utils::span<const double> by_query_histogram_bounds);
