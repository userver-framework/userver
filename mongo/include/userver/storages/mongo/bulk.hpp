...
template <typename... Options>
void Bulk::ReplaceOne(formats::bson::Document selector, formats::bson::Document replacement, Options&&... options) {
    bulk_ops::ReplaceOne replace_subop(std::move(selector), std::move(replacement));
    (replace_subop.SetOption(std::forward<Options>(options)), ...);
    Append(replace_subop);
}

template <typename... Options>
void Bulk::UpdateOne(formats::bson::Document selector, formats::bson::Document update, Options&&... options) {
...
void Bulk::DeleteOne(formats::bson::Document selector, Options&&... options) {
    bulk_ops::Delete delete_subop(bulk_ops::Delete::Mode::kSingle, std::move(selector));
...
void Bulk::DeleteMany(formats::bson::Document selector, Options&&... options) {
    bulk_ops::Delete delete_subop(bulk_ops::Delete::Mode::kMulti, std::move(selector));
    (delete_subop.SetOption(std::forward<Options>(options)), ...);
    Append(delete_subop);
}
