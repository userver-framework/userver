...
void OperationStopwatch::AccountError(MongoError::Kind kind) { Account(ToErrorType(kind)); }
...
std::size_t std::hash<USERVER_NAMESPACE::storages::mongo::stats::OperationKey>::operator()(
    USERVER_NAMESPACE::storages::mongo::stats::OperationKey value
) const {
