...
UTEST_F(DistLockTest, TestOwner) {
    ...
    UEXPECT_THROW(strategy1.Acquire(1s, "second"), dist_lock::LockIsAcquiredByAnotherHostException);
    UASSERT_THROW(strategy2.Acquire(1s, {}), dist_lock::LockIsAcquiredByAnotherHostException);
