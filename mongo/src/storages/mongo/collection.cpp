...
size_t Collection::Execute(const operations::Count& count_op) const { return impl_->Execute(count_op); }

size_t Collection::Execute(const operations::CountApprox& count_approx_op) const {
...
WriteResult Collection::Execute(const operations::ReplaceOne& replace_op) { return impl_->Execute(replace_op); }

WriteResult Collection::Execute(const operations::Update& update_op) { return impl_->Execute(update_op); }

WriteResult Collection::Execute(const operations::Delete& delete_op) { return impl_->Execute(delete_op); }

WriteResult Collection::Execute(const operations::FindAndModify& fam_op) { return impl_->Execute(fam_op); }

WriteResult Collection::Execute(const operations::FindAndRemove& fam_op) { return impl_->Execute(fam_op); }

WriteResult Collection::Execute(operations::Bulk&& bulk_op) { return impl_->Execute(std::move(bulk_op)); }
