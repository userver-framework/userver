...
const char* NameForType(bson_type_t type) {
    ...
    UINVARIANT(false, fmt::format("Invalid bson_type_t: {}", utils::UnderlyingValue(type)));
}
...
TypeMismatchException::TypeMismatchException(bson_type_t actual, bson_type_t expected, std::string_view path)
