...
const std::map<std::string, SqlState> CODESTR_TO_STATE{
    ...
    {"01004", SqlState::kStringDataRightTruncationWarning},
    ...
    {"38002", SqlState::kModifyingSqlDataNotPermittedExtRoutine},
    {"38003", SqlState::kProhibitedSqlStatementAttemptedExtRoutine},
    {"38004", SqlState::kReadingSqlDataNotPermittedExtRoutine},
    //@}
    //@{
    ...
    {"39004", SqlState::kNullValueNotAllowedExtRoutine},
