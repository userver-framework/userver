...
userver::formats::json::Value Handler::HandleRequestJsonThrow(
    ...
    const auto res_find_comments = pg_cluster_->Execute(userver::storages::postgres::ClusterHostType::kSlave,
                        sql::kFindCommentByArticleId.data(), 
                        article_id);

    const auto comments = res_find_comments.AsContainer<std::vector<real_medium::models::Comment>>(userver::storages::postgres::kRowTag);
