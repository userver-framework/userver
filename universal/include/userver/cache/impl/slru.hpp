...
public:
    ...
    void SetMaxSize(std::size_t new_probation_size, std::size_t new_protected_size);
...
template <typename T, typename U, typename Hash, typename Equal>
typename SlruBase<T, U, Hash, Equal>::NodeType SlruBase<T, U, Hash, Equal>::ExtractLeastUsedNode() {
    return probation_part_.ExtractLeastUsedNode();
}

template <typename T, typename U, typename Hash, typename Equal>
void SlruBase<T, U, Hash, Equal>::SetMaxSize(std::size_t new_probation_size, std::size_t new_protected_size) {
...
template <typename T, typename U, typename Hash, typename Equal>
typename SlruBase<T, U, Hash, Equal>::NodeType SlruBase<T, U, Hash, Equal>::ExtractNode(const T& key) noexcept {
