...
TEST(Decimal64, ToStringTrailingZeros) {
    ...
    EXPECT_EQ(decimal64::ToStringTrailingZeros(decimal64::Decimal<18>{"1"}), "1.000000000000000000");
    EXPECT_EQ(decimal64::ToStringTrailingZeros(decimal64::Decimal<5>{"1"}), "1.00000");
...
TEST(Decimal64, Fmt) {
    ...
    EXPECT_THROW(static_cast<void>(fmt::format(fmt::runtime("{:.5f}"), Dec4{"12.34"})), fmt::format_error);
    EXPECT_THROW(static_cast<void>(fmt::format(fmt::runtime("{:s}"), Dec4{42})), fmt::format_error);
    EXPECT_THROW(static_cast<void>(fmt::format(fmt::runtime("{:s}"), Dec4{42})), fmt::format_error);
}
