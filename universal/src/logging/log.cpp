...
auto& NonOwningDefaultLoggerInternal() noexcept {
    ...
    // logger at all.
    static std::atomic<impl::LoggerBase*> default_logger_ptr{&logging::GetNullLogger()};
...
bool StaticLogEntry::ShouldNotLog(logging::LoggerRef logger, logging::Level level) const noexcept {
