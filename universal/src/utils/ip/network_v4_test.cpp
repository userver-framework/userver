...
TEST(NetworkV4Test, FromStringTests) {
  ...
  EXPECT_THROW(NetworkV4FromString("1.1.1.256/24"), userver::utils::ip::AddressSystemError);
  ...
  EXPECT_THROW(NetworkV4FromString("abcdef/24"), userver::utils::ip::AddressSystemError);
  EXPECT_THROW(NetworkV4FromString("1.1.1.1/"), std::invalid_argument);
