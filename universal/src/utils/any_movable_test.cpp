...
TEST(AnyMovable, MoveConstructors) {
    ...
    EXPECT_FALSE((std::is_constructible<utils::AnyMovable, const utils::AnyMovable&&>::value));
    EXPECT_FALSE((std::is_constructible<utils::AnyMovable, const utils::AnyMovable&>::value));
    EXPECT_FALSE((std::is_constructible<utils::AnyMovable, utils::AnyMovable&>::value));
    EXPECT_TRUE((std::is_constructible<utils::AnyMovable, utils::AnyMovable&&>::value));
}
