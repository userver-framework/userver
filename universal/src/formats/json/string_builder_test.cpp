...
formats::json::Value
Serialize(const Response200EchoobjectwithmappingA& value, formats::serialize::To<formats::json::Value>);
...
void WriteToStream(
    [[maybe_unused]] const Response200& value,
    formats::json::StringBuilder& sw,
    bool hide_brackets,
    [[maybe_unused]] const char* hide_field_name
) {
...
using StringBuilderIntegralTypes = ::testing::Types<
    signed char,
    short,
    int,
    long,
