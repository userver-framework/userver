...
REGISTER_TYPED_TEST_SUITE_P(
    ...
    BuildNewValueEveryTime,
    CheckPrimitiveTypesChange,
    CheckNestedTypesChange,

    CheckNestedArrayChange,
    ArrayResize,
    ArrayFromNull,
    ArrayPushBack,

    PushBackFromExisting,
    PushBackFromBefore,
    PushBackFromIterator,
    CopyExistingMember,
    CopyExistingMemberByIt, /* ModifyRemovedNode, */
    ContainerTypeChangeToScalar,
    ContainerTypeChangeArrToObj,
    ContainerTypeChangeObjToArr,

    PushBackWrongTypeThrows,
    ExtractFromSubBuilderThrows,
    ObjectIteratorModify,
    MemberEmpty,
    MemberCount,

    NonArrayThrowIsEmpty,
    NonArrayThrowGetSize,
    ArrayIteratorRead,
    ArrayIteratorModify,
    CreateSpecificType,
