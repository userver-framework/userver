...
testme::post::Response ClientImpl::TestmePost(const testme::post::Request& request ,          const USERVER_NAMESPACE::chaotic::openapi::client::CommandControl& command_control
) {
...
ApplyConfig(r, command_control, config_);        SerializeRequest(request, config_.base_url, r);
