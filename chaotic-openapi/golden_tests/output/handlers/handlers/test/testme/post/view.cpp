...
/*
std::string View::GetRequestBodyForLogging(const USERVER_NAMESPACE::formats::json::Value& body) {
(void)body;
return {};
}

std::string View::GetInvalidRequestBodyForLogging(const USERVER_NAMESPACE::server::http::HttpRequest& request) {
(void)request;
return {};
}
