...
file(GLOB DATA_FILES "${_DIR}/spdlog-*-data.cmake")
...
if(NOT TARGET spdlog::spdlog_header_only)
    ...
    message(${spdlog_MESSAGE_MODE} "Conan: Target declared 'spdlog::spdlog_header_only'")
endif()
# Load the debug and release library finders
get_filename_component(_DIR "${CMAKE_CURRENT_LIST_FILE}" PATH)
file(GLOB CONFIG_FILES "${_DIR}/spdlog-Target-*.cmake")
