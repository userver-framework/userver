...
file(GLOB DATA_FILES "${_DIR}/yaml-cpp-*-data.cmake")
...
if(NOT TARGET yaml-cpp)
    ...
    message(${yaml-cpp_MESSAGE_MODE} "Conan: Target declared 'yaml-cpp'")
endif()
# Load the debug and release library finders
get_filename_component(_DIR "${CMAKE_CURRENT_LIST_FILE}" PATH)
file(GLOB CONFIG_FILES "${_DIR}/yaml-cpp-Target-*.cmake")
