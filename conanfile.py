    ...
    def package(self):
        ...
        if self.options.with_grpc:
            ...
            list = copy(
                ...
                src=os.path.join(self.source_folder, 'grpc', 'handlers', 'include'),
                keep_path=True,
            )
            list = copy(
                self,
            ...
            replace_in_file(self, os.path.join(self.package_folder, 'cmake', "GrpcTargets.cmake"), "userver-grpc", "userver::grpc")
