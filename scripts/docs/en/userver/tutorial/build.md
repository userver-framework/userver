...
|----------------------------------------|------------------------------------------------------------------------------|--------------------------------------------------|
| USERVER_FEATURE_MONGODB                | Provide asynchronous driver for MongoDB                                      | ${USERVER_BUILD_PLATFORM_X86}                    |
...
| USERVER_FEATURE_CLICKHOUSE             | Provide asynchronous driver for ClickHouse                                   | ${USERVER_BUILD_PLATFORM_X86}                    |
