...
className:"link",begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}}})());hljs.registerLanguage("cpp",(()=>{"use strict";function e(e){
...
;return n.name="C",n.aliases=["c","h"],n}})());hljs.registerLanguage("nginx",(()=>{"use strict";return e=>{const n={
...
end:/$/}]})})());hljs.registerLanguage("sql",(()=>{"use strict";return e=>{
...
illegal:/\S/,contains:[e.C_BLOCK_COMMENT_MODE,{begin:/;/},a]}]}}})());hljs.registerLanguage("asciidoc",(()=>{"use strict";return e=>({name:"AsciiDoc",
...
},e.HASH_COMMENT_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE]})})());hljs.registerLanguage("plaintext",(()=>{"use strict";return t=>({
