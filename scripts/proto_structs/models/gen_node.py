...
class EnumNode(TypeNode, names.HasVanillaName):
    ...
    def __init__(
        ...
        *,
        ...
        #: Postfix to add to the enum name, e.g. if it is nested in a proto message.
        self._vanilla_enum_name_postfix: Final[str] = vanilla_enum_name_postfix
    ...
    @property
    def vanilla_full_enum_name(self) -> str:
        """
        Returns the vanilla enum name, including the provided postfix.

        This addresses cases where the generated protobuf enum name differs
        from its enclosing struct name due to nesting. This property is used to
        gain access to the autogenerated protobuf functions for such enums.
        ...
        Here, the full protobuf enum name would be `NestedTrickEnum_NestedTrick`.
        """

        return self.vanilla_full_name + self._vanilla_enum_name_postfix
